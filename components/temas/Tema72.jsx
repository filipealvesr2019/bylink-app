...
import styles from "./Tema72.module.css";
const Tema72 = ({ CriarPagina }) => {
  ...
  return (
    ...
    <button className={styles.button} data-content={link.name}><span>{link.name}</span></button>
